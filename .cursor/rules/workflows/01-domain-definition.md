...
"`@00-memory.md`의 **초기 설정** 섹션이 완료되었는지 확인해주세요:"

**확인 항목**:

- [ ] 프로젝트 정보 입력 완료
- [ ] 폴더 구조 정의 완료 (src/, pages/, features/, shared/ 등)
- [ ] 기술 스택 정의 완료 (React, TypeScript, Tailwind 등)
- [ ] 디자인 시스템 정보 입력 완료 (토큰 경로, 스타일링 방식)
