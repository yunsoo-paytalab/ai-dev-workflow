...
- **필수 참조**: @memory.md, 1, 2단계 결과물 (memory.md에서 자동 참조)
...
- **Phase**: Phase 2 (도메인별 상세 작업)
- **Context 제한**: 도메인별 작업 (context 길이 제한 내에서 작업)
- **필수 참조**: @memory.md, 2단계 결과물, 3-1 단계 결과물 (memory.md에서 자동 참조)
...
- **Phase**: Phase 2 (도메인별 상세 작업)
- **Context 제한**: 도메인별 작업 (context 길이 제한 내에서 작업)
- **필수 참조**: @memory.md, 1, 2단계 결과물, 3-1, 3-2 단계 결과물 (memory.md에서 자동 참조)
...
- **Phase**: Phase 2 (도메인별 상세 작업)
- **Context 제한**: 도메인별 작업 (context 길이 제한 내에서 작업)
- **필수 참조**: @memory.md, 1, 2, 3-1, 3-2, 3-3 단계 결과물 (memory.md에서 자동 참조)
