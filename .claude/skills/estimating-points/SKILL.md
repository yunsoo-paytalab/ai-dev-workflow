...
Feature 단위의 복잡도와 불확실성을 기반으로 포인트를 산정하는 전략 가이드입니다.
...
| 포인트 | 배율 | 가이드                                           |
| ------ | ---- | ------------------------------------------------ |
| 1      | 1x   | [reference/1pt.md](reference/1pt.md)             |
| 2-3    | 2-3x | [reference/2-3pt.md](reference/2-3pt.md)         |
| 5-8    | 5-8x | [reference/5-8pt.md](reference/5-8pt.md)         |
| 13+    | 13+x | [reference/13pt-plus.md](reference/13pt-plus.md) |
