...
- Feature Research 문서를 `.claude/docs/research/` 디렉토리에 저장
- 파일명: `[기능 ID]-research.md` (예: `AUTH-001-research.md`)
- **요구사항 분석 섹션만 작성** (기술 설계 및 계획은 planning-agent가 별도 파일로 작성)
...
3. **Implementation Plan (섹션 2~4)**
   ...
   - planning-agent가 별도 파일(`.claude/docs/plan/[Feature ID]-plan.md`)로 작성함
